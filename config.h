...
static char selbgcolor[]            = "#507aa4" /*#005577" "#00cfff"*/;
...
static Key keys[] = {
	...
	//{ MODKEY|ShiftMask,		XK_e,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "curl wttr.in/Novi+Sad", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_m,		spawn,		SHCMD("pulsemixer -t; kill -44 $(pidof dwmblocks)") },
	...
	//{{{ MODKEY,			XK_F2,		spawn,		{.v = (const char*[]){ "tutorialvids", NULL } } },
	{ MODKEY,			XK_F2,		spawn,	 	SHCMD("maim pic-full-$(date '+%y%m%d-%H%M-%S').png") },
	{ MODKEY,			XK_F3,		spawn,		SHCMD("maim --select pic-full-$(date '+%y%m%d-%H%M-%S').png") },
